...
class ServiceRequestAttempt extends Model
{
    protected $fillable = [
        ...
        'request_payload', 'sensitive_input_keys', 'response_payload', 'mapped_response', 'response_raw', 'http_status', 'duration_ms',
        'price_amount', 'error_code', 'error_message', 'started_at', 'completed_at',
    ];

    protected $hidden = ['request_payload', 'sensitive_input_keys', 'response_payload', 'mapped_response', 'response_raw'];
